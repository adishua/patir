            ...
            <div className="prose prose-blue max-w-none text-gray-700 space-y-6 text-lg leading-relaxed">
              <section>
                ...
                <p>
                  ...
                  אנו משקיעים משאבים רבים כדי להבטיח שהאתר יהיה ידידותי ונוח לשימוש, מתוך אמונה כי לכל אדם מגיעה הזכות לחיות בשוויון, כבוד, נוחות ועצמאות.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  ...
                  ועומד בדרישות תקן WCAG 2.1 ברמה AA.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  למרות מאמצנו להנגיש את כלל הדפים באתר, ייתכן ויתגלו חלקים או יכולות שלא הונגשו כראוי או שטרם הונגשו. 
              ...
              <section className="bg-blue-50 p-6 rounded-2xl">
                ...
                <p>
                  בכל שאלה, הצעה לשיפור או תקלה בנושא נגישות, ניתן לפנות לרכז הנגישות שלנו:
                </p>
