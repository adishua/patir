...
export const metadata: Metadata = {
  title: 'תנאי שימוש',
  description: 'תנאי שימוש באתר פתיר - שירותים משפטיים',
}
          ...
          <div className="reveal-up">
            ...
            <div className="prose prose-blue max-w-none text-gray-700 space-y-6 text-lg leading-relaxed">
              <section>
                ...
                <p>
                  השימוש באתר זה מהווה הסכמה לתנאי השימוש המפורטים להלן. אם אינך מסכים לתנאים אלה, אנא
                  הימנע משימוש באתר.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  אתר "פתיר" מספק מידע כללי על שירותים משפטיים ומאפשר יצירת קשר לקבלת ייעוץ. המידע באתר
                  אינו מהווה ייעוץ משפטי ואינו מחליף התייעצות עם עורך דין.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  ...
                  ומוגנים על ידי חוקי זכויות יוצרים. אין להעתיק, לשכפל או להפיץ תכנים מהאתר ללא אישור מראש
                  ובכתב.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  המידע באתר מסופק "כמות שהוא" (AS IS). אנו עושים מאמצים לשמור על דיוק המידע, אך איננו
                  מתחייבים לשלמותו או לעדכניותו. השימוש במידע הוא על אחריות המשתמש בלבד.
                </p>
                <p className="mt-4">
                  לא נישא באחריות לכל נזק ישיר או עקיף שייגרם כתוצאה מהשימוש באתר או מהסתמכות על המידע
                  המופיע בו.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  האתר עשוי להכיל קישורים לאתרים חיצוניים. איננו אחראים לתוכן, למדיניות הפרטיות או
                  לפרקטיקות של אתרים אלה.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  אנו שומרים לעצמנו את הזכות לעדכן או לשנות תנאים אלה בכל עת. שינויים ייכנסו לתוקף עם
                  פרסומם באתר. המשך השימוש באתר לאחר פרסום השינויים מהווה הסכמה לתנאים המעודכנים.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  על תנאי שימוש אלה יחולו דיני מדינת ישראל בלבד. סמכות השיפוט הבלעדית בכל עניין הנוגע
                  לתנאים אלה תהיה לבתי המשפט המוסמכים בתל אביב-יפו.
                </p>
              </section>
