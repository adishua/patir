        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8 mb-12">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-blue-100 text-sm leading-relaxed mb-6">
              פתרונות משפטיים מהירים, מקצועיים ודיסקרטיים. אנחנו כאן כדי להחזיר את השקט לחיים שלך.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-blue-100">
              ...
              <li>
                <FooterNavLink to="about">אודות</FooterNavLink>
              </li>
              <li>
                <FooterNavLink to="services">שירותים</FooterNavLink>
              </li>
              <li>
                <FooterNavLink to="contact">צור קשר</FooterNavLink>
              </li>
              <li>
